...
<head>
  ...
  <title>Home - Pharma Company</title>
  <!-- Bootstrap CSS -->
...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="back.png" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  <body background="image.png" style="background-repeat: no-repeat; background-size: cover;">


  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany. All rights reserved. BY R.MAHALAKSHMI (212223230117)</p>
  </footer>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>About Pharma Company</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
  ...
  <body background="image.png" style="background-repeat: no-repeat; background-size: cover;"></body>
  <!-- Footer -->
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Products - Pharma Company</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Contact Us - Pharma Company</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
...
```
## OUTPUT:
![alt text](<Screenshot 2024-05-12 131614.png>)
![alt text](<Screenshot 2024-05-12 131633.png>)
![alt text](<Screenshot 2024-05-12 131647.png>)
![alt text](<Screenshot 2024-05-12 131657.png>)
